...
launch_xvfb() {
    ...
    local resolution=${XVFB_RESOLUTION:-1680x1050x24}
...
run_xterm() {
    ...
    xrdb ~/.Xresources
    xterm -u8 -en zh_CN.UTF-8 -T Bash -e /bin/bash -l &
    xterm -u8 -en zh_CN.UTF-8 -T Bash -e '/usr/bin/python3.6 /home/c/wuyi/MyScheduler slave_wandou' &
    xterm -u8 -en zh_CN.UTF-8 -T Bash -e '/usr/bin/python3.6 /home/c/wuyi/MyWebServer' &
    autossh -M 0 -o "ServerAliveInterval 10" -o "ServerAliveCountMax 3" -fCNg -L 27017:127.0.0.1:27017 wuyi@116.62.125.239 &
}
...
run_vnc_server() {
    ...
    x11vnc -shared -display ${DISPLAY} -forever ${passwordArgument} &
    wait $!
}
